...
Parser.prototype.getContext = function (token, str) {
    str = str.trim()
...
Parser.prototype.gather = function (source, callback) {
    var s = source
...
Parser.prototype.trimLine = function (str) {
    str = str.trim()
